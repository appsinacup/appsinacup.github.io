...
- a modified version of [doceazedo/godot_wry](https://github.com/doceazedo/godot_wry), [appsinacup/godot_wry](https://github.com/appsinacup/godot_wry) for the webview. Fixes a bunch of stuff in godot_wry for it to be able to run in editor, open popup links (For authentication), and more (also opened PR's to fix them in mainstream repo)
